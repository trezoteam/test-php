...
namespace DoctrineORMModule\Proxy\__CG__\Application\Entidade;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Question extends \Application\Entidade\Question implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entidade\\Question' . "\0" . 'subject', '' . "\0" . 'Application\\Entidade\\Question' . "\0" . 'createdAt', '' . "\0" . 'Application\\Entidade\\Question' . "\0" . 'updatedAt', '' . "\0" . 'Application\\Entidade\\Question' . "\0" . 'id', '' . "\0" . 'Application\\Entidade\\Question' . "\0" . 'quiz', '' . "\0" . 'Application\\Entidade\\Question' . "\0" . 'type', '' . "\0" . 'Application\\Entidade\\Question' . "\0" . 'quiz_id'];
        }
    ...
    public function setQuizId($quiz_id)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setQuizId', [$quiz_id]);

        return parent::setQuizId($quiz_id);
    }
