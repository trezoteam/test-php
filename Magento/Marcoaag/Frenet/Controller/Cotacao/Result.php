...
namespace Marcoaag\Frenet\Controller\Cotacao;
...
class Result extends \Magento\Framework\App\Action\Action
{
    ...
    {
        //$api_token = $this->helper('Marcoaag\Frenet\Helper\Data')->getConfig(self::XML_PATH_API_TOKEN);
        $api_token = $this->_objectManager->create('Marcoaag\Frenet\Helper\Data')->getConfig(self::XML_PATH_API_TOKEN);
